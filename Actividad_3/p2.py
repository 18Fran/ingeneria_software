...
log_file = open_file("a3_al02859552_" + datetime.now().strftime("%d-%m-%Y_%H:%M:%S") + ".txt", mode="w+")
...
for file in files:
    ...
    words = sort_strings(word_list_from_string(remove_html_tags(file, FILES_PATH)))
    print(words)
